...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                KC_LCTL,   LT(_LEFT,KC_ENT),  LT(_LOWER,KC_SPC),            LT(_RAISE,KC_ENT),LT(_RIGHT,KC_SPC), KC_RALT
                                      //`--------------------------'  `--------------------------'
...
void oled_render_layer_state(void) {
    ...
    switch (layer_state) {
        case L_BASE:
            ...
            break;
        case L_LOWER:
            oled_write_ln_P(PSTR("_LOWER"), false);
            break;
        case L_RAISE:
            oled_write_ln_P(PSTR("_RAISE"), false);
            break;
        case L_LEFT:
            oled_write_ln_P(PSTR("_LEFT"), false);
            break;
        case L_RIGHT:
            oled_write_ln_P(PSTR("_RIGHT"), false);
            break;
        default:
